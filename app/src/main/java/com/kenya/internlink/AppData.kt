...
class AppData {
    companion object{
        val testimonials = arrayOf(
            ...
            Testimonial("John Njoroge","Doctor" ,"Mama Lucy National Hosptal.","\"This app is a game-changer! I was able to browse through various industries and apply for internships with just a few clicks. I'm grateful for the opportunity I got through this platform."),
